...
def build(output):
    ...
    story += [P("Universe selection", "Sub"),
              ...
              P("<b>Live rule and compliance boundary.</b> The proposed live implementation ranks the full NSE F&amp;O universe by 20-day average option-segment turnover and open interest, takes the top 12, and excludes names in the F&amp;O ban period on more than 10% of in-sample days. This demonstration did not execute that all-market ranking: it validated liquidity after directly choosing the shortlist. The result therefore retains selection and survivorship bias and only partially satisfies the brief's objective-screen requirement.", "Callout")]
    ...
    coverage_rows = [["Assignment item", "Report evidence", "Status"],
                     ...
                     ["Objective 8-15 stock liquidity screen", "Live 20-day turnover/OI and ban-day rule documented; demonstration shortlist chosen directly", "Partial"],
