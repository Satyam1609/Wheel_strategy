...
def build(output):
    ...
    story += [P("6. Limitations, sources and reproducibility", "Section"),
              ...
              P(f"<b>Deployability verdict.</b> The stock wheel returned {pct(by_series['wheel']['CAGR'])} annualized and the synthetic NIFTY wheel returned {pct(nw['CAGR'])}, versus {pct(by_series['nifty_tr']['CAGR'])} for NIFTY 50 total return. Part A retains its documented 6.5% cash-yield assumption; Part B credits no interest because its cash is treated as non-interest-bearing option security or futures margin. The evidence is not sufficient for a production deployment claim until execution prices and historical margins are tested with more realistic data and the Part A universe is selected objectively.", "Callout"),
